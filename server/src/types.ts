...
import { CommentModel, LikeModel, UserModel } from './models';
...
export type ResolversTypes = {
    Article: ResolverTypeWrapper<
        Omit<Article, 'author' | 'comments' | 'likes'> & {
            author: ResolversTypes['User'];
            comments?: Maybe<Array<Maybe<ResolversTypes['Comment']>>>;
            likes?: Maybe<Array<Maybe<ResolversTypes['Like']>>>;
        }
    >;
...
export type ResolversParentTypes = {
    Article: Omit<Article, 'author' | 'comments' | 'likes'> & {
        author: ResolversParentTypes['User'];
        comments?: Maybe<Array<Maybe<ResolversParentTypes['Comment']>>>;
        likes?: Maybe<Array<Maybe<ResolversParentTypes['Like']>>>;
    };
...
> = {
    addComment?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationAddCommentArgs, 'articleId' | 'content'>
    >;
    ...
    >;
    likeArticle?: Resolver<
        Maybe<ResolversTypes['Like']>,
        ParentType,
        ContextType,
        RequireFields<MutationLikeArticleArgs, 'articleId'>
    >;
    login?: Resolver<
    ...
    updateArticle?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationUpdateArticleArgs, 'id'>
    >;
};
...
> = {
    getArticleById?: Resolver<
        Maybe<ResolversTypes['Article']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetArticleByIdArgs, 'id'>
    >;
    getArticles?: Resolver<
        Maybe<Array<Maybe<ResolversTypes['Article']>>>,
        ParentType,
        ContextType,
        Partial<QueryGetArticlesArgs>
    >;
    getCommentsByArticleId?: Resolver<
        Maybe<Array<Maybe<ResolversTypes['Comment']>>>,
        ParentType,
        ContextType,
        RequireFields<QueryGetCommentsByArticleIdArgs, 'articleId'>
    >;
